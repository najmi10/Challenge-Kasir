...
public class apkKasir {
    void apk(){
        ...
        System.out.print("Silahkan Masukkan Tanggal (DD-MM-YYY): ");
        String tanggal = caca.next();
        System.out.print("Silahkan Masukkan Nama Kasir         : ");
        String namakasir = caca.next();
        System.out.println("\n^ === KAKIKU === ^");
        ...
        System.out.println("   Jl. Danau Laut Manis G7B18, Sawojajar - Kota Malang");
